...
# tilesURL = reactive(
#     paste0("https://dev-csasl-inhabit.s3-us-west-2.amazonaws.com/",species(),'/',model(),"/",mess(),"/{z}/{x}/{y}.png",sep=''))
...
# url = 'https://www.sciencebase.gov/catalogMaps/mapping/ows/5e20c7e5e4b0ecf25c65af7e?version%3D1.3.0'
# leaflet(options = leafletOptions(maxZoom = 10, preferCanvas = T)) %>%
...
#               layers = 'ensemble_1st_3857',
#               options = WMSTileOptions(transparent = T, version = "1.3.0", format = "image/png", crs = "EPSG:3857"))
...
About
=====================================
This tool is designed to display spatial and aspatial outputs from models of exotic species as completed by USGS FORT utilizing the <a href="https://pubs.er.usgs.gov/publication/fs20143007" target="_blank">Software for Assisted Habitat Modeling (SAHM)</a>.
