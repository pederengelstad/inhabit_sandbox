...
checkboxGroupButtons(inputId = "mgmt.admin", direction = 'vertical', 
                     choices = c('BLM Districts', 'IPMT', "FWS", "NPS", 'U.S. Counties'), 
                     status = "primary", individual = T, size = 'sm', 
                     selected = c('BLM Districts', 'IPMT', 'FWS', "NPS", 'U.S. Counties'), 
...
```{r}
renderImage(list(src = './test2.png', contentType = 'image/png', width='50%', align='center'), deleteFile = F)
renderText(print(sp_list$global[sp_list$lower==species()]))
...
Management Area Suitability Summary
=====================================
