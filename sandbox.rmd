...
<!-- ```{r} -->
<!-- sp_list = as.list(read.csv('sp_list.csv', header = T, stringsAsFactors = F)) -->
<!-- shiny::selectInput('sp_select', label = 'Species of interest:', choices = sp_list$common, selected = "Ravennagrass", -->
...
<!-- ```{r} -->
<!-- flexdashboard::renderValueBox(flexdashboard::valueBox(value = 1, icon = 'fa-globe-americas',  -->
<!--                                                       caption = tags$p("Number of Presence Points Used", style = "font-size: 300%;"))) -->
<!-- ``` -->

<!-- ### Top Three Predictors -->

<!-- ```{r} -->
<!-- shinydashboard::renderInfoBox(shinydashboard::infoBox(title = "Top Predictors", value = "1. One \n 2. Two")) -->
<!-- ``` -->
...
<!-- ```{r} -->
<!-- renderGauge(flexdashboard::gauge(value = 10000, min = 0, max = 100000)) -->
<!-- ``` -->
...
Funding and support for INHABIT comes from USGS, U.S. Fish and Wildlife, Biodiversity Information Serving Our Nation (BISON), and the National Park Service.
