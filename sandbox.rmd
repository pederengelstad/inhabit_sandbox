    ...
    if(!is.null(p)){
      leafletProxy("map") %>%
        ...
        addCircleMarkers(data = pres_pts(), group = 'pres_pts', fillColor = "#fd00ff"
                         , radius = 3.5, fillOpacity = 1, color = '#5e0c5e', weight = 1
                         )
    } else {
        leafletProxy("map") %>%
          clearGroup('pres_pts')
...
```{r}
# img = reactive({paste0('<center><img src=\"/species/',species(),'/responsecurves.png\" width=\"600\"></center>',sep='')})
# img = reactive({paste0('<img src="species/',species(),'/responsecurves.png">', sep='')})
 # paste('<center><img src="/species/','redbrome','/responsecurves.png" width="600"></center>',sep='')
# renderText(print(img()))

renderText({
  HTML(
    kable(x = data.frame(col = c('<center><img src="species/redbrome/responsecurves.png" width="600"></center>')),
              escape = F, col.names = '', align = 'c') %>%
      kable_styling(full_width = F,
                    position = 'center',
                    bootstrap_options = c("condensed", "responsive")) %>%
      column_spec(1, border_right = F, width = '70%')
  )
})
