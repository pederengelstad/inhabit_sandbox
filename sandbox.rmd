...
Funding for INHABIT comes from <a href="https://www.usgs.gov/core-science-systems/science-analytics-and-synthesis" target="_blank">USGS Core Science Systems (CSS): Science Analytics and Synthesis (SAS)</a> and the U.S. Fish and Wildlife Service. Continued development is in partnership with the <a href="https://www.nps.gov/orgs/1103/epmt.htm" target="_blank">National Park Service's Exotic Plant Management Teams</a>.  INHABIT is also logistically supported by <a href="https://bison.usgs.gov/" target="_blank">Biodiversity Information Serving Our Nation (BISON)</a> and the <a href="https://itis.gov/" target="_blank">Integrated Taxonomic Information System (ITIS)</a>.
